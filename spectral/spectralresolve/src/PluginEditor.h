...
private:
    ...
    juce::Colour getColourParam(int idx) const;
    ...
    // Show Freq toggle & Peak tracking
    juce::TextButton btnShowFreq;
    std::unique_ptr<juce::AudioProcessorValueTreeState::ButtonAttachment> attachShowFreq;
    float smoothedPeakFreq{ 0.f };

    juce::TextButton btnHfWeight;
    juce::Slider hfWeightThreshSlider;
    juce::Label  hfWeightThreshLabel;
    std::unique_ptr<juce::AudioProcessorValueTreeState::ButtonAttachment> attachHfWeightOn;
    std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment> attachHfWeightCutoff;
