...
### [SpectralCompress](spectralcompress/)
...
that splits incoming audio into ~240 narrow log-spaced bands (36 bands per
octave, ~33 cent resolution), tracks each band's amplitude, and re-sings that
amplitude through its own sine oscillator retuned onto a scale, a chord
matrix, or the notes you're currently holding on a MIDI keyboard. The result:
whatever you play in — a bassline, a chord, a vocal, a loop — comes back out
locked to musical pitches, with the original transient/noise content still
under your control.
