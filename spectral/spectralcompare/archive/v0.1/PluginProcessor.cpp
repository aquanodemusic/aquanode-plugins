...
void SpectralCompareAudioProcessor::resetColors()
{
    ...
    mainSpectrumColor     = juce::Colour(0xff55eedd);
    sidechainSpectrumColor= juce::Colour(0xffff6644);
...
void SpectralCompareAudioProcessor::setStateInformation(const void* data, int sizeInBytes)
{
    if (auto xml = getXmlFromBinary(data, sizeInBytes))
    {
        ...
        mainSpectrumColor     = juce::Colour((juce::uint32)xml->getIntAttribute("mainColor",      (int)0xff55eedd));
        sidechainSpectrumColor= juce::Colour((juce::uint32)xml->getIntAttribute("sidechainColor", (int)0xffff6644));
