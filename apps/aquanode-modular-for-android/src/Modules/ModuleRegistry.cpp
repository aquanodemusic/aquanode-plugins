...
extern "C" bool AudioThruModule_aqRegistered;
extern "C" bool LimiterModule_aqRegistered;
extern "C" bool DiscardMidiModule_aqRegistered;
extern "C" bool DrawLFOModule_aqRegistered;
...
extern "C" bool DropletsModule_aqRegistered;
...
int forceLinkAllModules()
{
    ...
    sink ^= AudioThruModule_aqRegistered;
    sink ^= LimiterModule_aqRegistered;
    sink ^= DiscardMidiModule_aqRegistered;
    sink ^= DrawLFOModule_aqRegistered;
    ...
    sink ^= DropletsModule_aqRegistered;
    sink ^= PolySumModule_aqRegistered;
