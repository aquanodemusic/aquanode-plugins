...
| <img src="synths/aqua-vibrio/assets/GUI.png" width="64" align="center" /><br />**[Aquanova](synths/aqua-vibrio/)** | A synth modelled after the Access Virus TI with automatic preset generation capabilities. Same workflow, sound from scratch re-using the DSP from the modules from Aquanode Modular. |
