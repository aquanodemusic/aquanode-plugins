...
| <img src="synths/alphabetasynth/assets/GUI.png" width="64" align="center" /><br />**[AlphaBetaSynth](synths/alphabetasynth/)** | A synthesizer modelled after the free but discontinued LinPlug Alpha 3, with its characteristic liquid, smooth sweeping filter sound that washes out beautifully with the chorus. |
...
| <img src="synths/aqua-vibrio/assets/GUI.png" width="64" align="center" /><br />**[Aqua Vibrio](synths/aqua-vibrio/)** | A synth modelled after the Access Virus TI with automatic preset generation capabilities. Same workflow, sound from scratch re-using the DSP from the modules from Aquanode Modular. |
| <img src="synths/aquanova/assets/GUI.png" width="64" align="center" /><br />**[Aquanova](synths/aquanova/)** | A synth modelled after the Novation Supernova II with automatic preset generation capabilities. Same workflow, sound from scratch re-using the DSP from the modules from Aquanode Modular. |
