...
public:
    ...
    // ── Scale in-scale transpose (applied after chord logic, before global transpose) ──
    juce::AudioParameterInt* scaleTransposeParam = nullptr;  // -12 to +12 in-scale steps

    // ── Add Length: delays every outgoing note-off by this many seconds ───────
    juce::AudioParameterFloat* addLengthParam = nullptr;  // 0 to 10 s, default 0
    ...
    juce::AudioParameterBool* scaleTransposeRootParam = nullptr;
    ...
    // ── Cluster animation – Scale mode ────────────────────────────────────────────
    juce::AudioParameterInt* clusterLowNotesParam = nullptr;  // 1-12
    juce::AudioParameterInt* clusterHighNotesParam = nullptr;  // 1-12
    juce::AudioParameterInt* clusterLowOctStartParam = nullptr;  // 0-9
    juce::AudioParameterInt* clusterLowOctEndParam = nullptr;  // 0-9
    juce::AudioParameterInt* clusterHighOctStartParam = nullptr;  // 0-9
    juce::AudioParameterInt* clusterHighOctEndParam = nullptr;  // 0-9
    juce::AudioParameterInt* clusterVelMinParam = nullptr;
    juce::AudioParameterInt* clusterVelMaxParam = nullptr;
    juce::AudioParameterFloat* clusterDecayParam = nullptr;  // 20-5000 ms

    // ── Cluster animation – PerNote / Custom mode ──────────────────────────────────
    juce::AudioParameterInt* pnClusterLowNotesParam = nullptr;
    juce::AudioParameterInt* pnClusterHighNotesParam = nullptr;
    juce::AudioParameterInt* pnClusterLowOctStartParam = nullptr;
    juce::AudioParameterInt* pnClusterLowOctEndParam = nullptr;
    juce::AudioParameterInt* pnClusterHighOctStartParam = nullptr;
    juce::AudioParameterInt* pnClusterHighOctEndParam = nullptr;
    juce::AudioParameterInt* pnClusterVelMinParam = nullptr;
    juce::AudioParameterInt* pnClusterVelMaxParam = nullptr;
    juce::AudioParameterFloat* pnClusterDecayParam = nullptr;
...
private:
    ...
    // ── Add-Length deferred note-off (fires after the sustain delay) ──────────
    ...
    // prevTranspose: the global transpose value used in the previous block.
    // prevScaleTranspose: the scale transpose value used in the previous block.
    ...
    void tickCluster(AnimNoteState&, int ch, int samplePos, juce::MidiBuffer&);
