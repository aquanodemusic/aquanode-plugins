...
{
public:
    // FORKED for Aqua Vibrio: added Spread, a true stereo offset of the LFO
    // between channels. Upstream has the first six parameters.
    enum ParamIndex { pRate = 0, pDepth, pCentre, pFeedback, pDryWet, pStages, pSpread };
