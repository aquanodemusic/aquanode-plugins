...
public:
    ...
    const SocketRef* findSocketNear (juce::Point<int> localPos, int radius = 12) const;
    ...
    static constexpr int moduleWidth = 220;
...
private:
    ...
    int cableIndexNear (juce::Point<float> pos, float maxDistance = 7.0f) const;
