...
static ModuleDescriptor analogDriftDescriptor()
{
    ...
    d.description =
        "The Oscillator with the digital precision sanded off: every voice and every unison "
        "partial wanders off pitch on its own random walk, notes start at random phase, and "
        "Unison stacks up to seven detuned copies across the stereo field. Sockets match the "
        "Oscillator - FM In wants another oscillator, Env In an ADSR. Drift and Phase Drift take "
        "mod cables happily. Unison and Voices do not, since they rebuild the voice stack rather "
        "than scale a signal.";
