...
static ModuleDescriptor formantDescriptor()
{
    ...
    d.description =
        "A singing oscillator: a buzzy glottal pulse feeds three band-passes sitting on the "
        "formant peaks that make a vowel a vowel, so morphing them turns the note into A-E-I-O-U. "
        "Unlike the Vocoder it needs no modulator signal, it sings on its own. Vowel In wants an "
        "LFO for talking pads; Env In wants an ADSR.";
