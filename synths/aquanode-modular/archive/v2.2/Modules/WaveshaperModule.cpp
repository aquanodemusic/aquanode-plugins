...
static aquanode::ModuleDescriptor waveshaperDescriptor()
{
    ...
    d.description =
        "Drive into a choice of curves: Tanh for smooth saturation, Sine Fold for wavefolding, "
        "Hard Clip, or Rectify. Flexible: fed per-voice, each note shapes on its own.";
