...
static ModuleDescriptor centerCombDescriptor()
{
    ...
    d.description =
        ...
        "thinning the outer peaks. Despite the name it has no delay line, so it colours rather "
        "than rings - for the ringing, pitched kind reach for True Comb instead.";
