...
private:
    ...
    // Wavetable cycle-edge smooth sliders (compact inline, next to Load buttons)
    juce::Slider smoothSliderA, smoothSliderB;
    juce::Label  smoothLabelA, smoothLabelB;
    std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment> smoothAttachA, smoothAttachB;
