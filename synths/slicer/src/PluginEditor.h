...
private:
    ...
    std::unique_ptr<juce::AudioProcessorValueTreeState::ComboBoxAttachment> interactionModeAttachment;
    std::unique_ptr<juce::AudioProcessorValueTreeState::ButtonAttachment> reverseModeAttachment;
    std::unique_ptr<juce::AudioProcessorValueTreeState::ButtonAttachment> loopModeAttachment;
    ...
    juce::ComboBox interactionModeCombo;  // "Add Slice on Click" vs "Play Slice on Click"
    juce::ToggleButton reverseModeButton;
    juce::ToggleButton loopModeButton;
