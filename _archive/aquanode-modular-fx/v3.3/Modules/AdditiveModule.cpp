...
static ModuleDescriptor additiveDescriptor()
{
    ...
    d.description =
        "Build a tone by drawing its harmonics directly, one bar per partial: where a subtractive "
        "voice starts rich and carves away, this starts silent and adds, so whatever you draw IS "
        "the spectrum. Env In wants an ADSR. The Partials chooser swaps between three separate "
        "sets of bars and never wipes them; Stretch pushes the partials off the harmonic series "
        "into bell and gong territory.";
