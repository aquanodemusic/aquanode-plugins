...
static ModuleDescriptor bowedDescriptor()
{
    ...
    d.displayName = "Bowed";
    d.description =
        "The sustaining half of physical modelling: where Pluck excites a string once and lets it "
        "move, this keeps feeding energy in, so it sings as long as you hold the note. Bow is a "
        "violin's stick-slip friction curve; Blow is a clarinet-ish reed. Pressure is the "
        "expressive control - too little and it whispers, too much and it sticks. Pairs "
        "beautifully with Voices = 1 and Glide.";
