                                          ...
                                          juce::MidiBuffer& midiMessages)
{
    ...
    // Scale delay lines by Size only — stereo width is handled in the output mix
    ...
    for (int n = 0; n < numSamples; ++n)
    {
        ...
        // tapAmount = 64 → densely diffused, smooth attack
        ...
        // Each FDN line is assigned to the left (even index) or right (odd index)
        // channel. "Spread" sets the maximum L/R separation (0 = mono, 1 = full split).
        // "Bloom Time" is the delay-time threshold: lines whose delay is shorter than
        // bloomTime stay central; lines whose delay exceeds bloomTime are fully panned.
        // "Bloom Amount" scales the maximum width independently of Spread.
        // Result: early reflections (short-delay lines) build up in the centre;
        // the reverb tail gradually opens into the stereo field.
