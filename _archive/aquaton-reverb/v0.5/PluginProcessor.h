...
public:
    ...
    // DSP CONSTANTS
    //==============================================================================
    static constexpr int NUM_LINES    = 64;   // Maximum FDN order (runtime order set by fdnOrder param)
    static constexpr int MAX_AP_TANK  = 256;  // Max allpass stages per tank line
    static constexpr int MAX_INPUT_AP = 64;   // Max input diffuser taps
    ...
    // 32 values, roughly log-spaced from ~1000 to ~8000 samples.
