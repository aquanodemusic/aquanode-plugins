...
// Firmware ROM and factory-voice data.
// These pointers are supplied by the host application (see PluginProcessor.cpp),
// which points them at the embedded contents of Firmware/dx7.bin (16384 bytes)
// and Firmware/voices.bin (32768 bytes = 8 factory banks x 4096).
extern const uint8_t* vdx7_firmware_rom;     // 16384 bytes
extern const uint8_t* vdx7_factory_voices;   // 32768 bytes
