...
{
    // Double-clicking anywhere on the title label resets the window to its
    // default size (560 × 592 px, the original design dimensions).
...
void NoteAdderEditor::resized()
{
    ...
    // ── Global control row 2: Transpose ─────────────────────────
    {
        ...
        globalTransposeSlider.setBounds(x, cy - 2, sliderW, sliderH);
    }
...

    {
        ...
        const int varBtnW = juce::roundToInt(160 * L.sf);
