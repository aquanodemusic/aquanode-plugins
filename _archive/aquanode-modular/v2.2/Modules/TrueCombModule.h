...
// True Comb - an actual delay-line comb filter, the Vital kind: a delay one
// wavelength long, fed back on itself, so the peaks land on the harmonic
// series of Freq and the thing rings at a pitch. (The older "Comb Filter"
...
class TrueCombModule : public aquanode::SynthModule
{
public:
