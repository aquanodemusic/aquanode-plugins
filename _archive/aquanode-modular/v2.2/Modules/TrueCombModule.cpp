#include "TrueCombModule.h"

using namespace aquanode;

//==============================================================================
void TrueCombModule::prepare (double sr)
{
...
void TrueCombModule::clearLane (int lane)
{
...
float TrueCombModule::readLine (const std::vector<float>& line, int lane, int ch,
...
void TrueCombModule::renderLane (int lane, const StereoFrame* inputs, StereoFrame* outputs)
{
...
//==============================================================================
static ModuleDescriptor trueCombDescriptor()
{
    ModuleDescriptor d;
    d.typeId = "filter.truecomb";
    d.displayName = "True Comb";
    d.description =
        "An actual delay-line comb unlike CenterComb: A delay one wavelength long fed back on "
    ...
    d.params = {
        makeRotary ("freq",       "Freq",       TrueCombModule::kMinFreq, TrueCombModule::kMaxFreq,
                                                220.0f, 0, "Hz", true),
...
AQUANODE_REGISTER_MODULE (TrueCombModule, trueCombDescriptor)
