...
static aquanode::ModuleDescriptor specEnhanceDescriptor()
{
    ...
    d.description =
        "The drawn curve is a per-bin magnitude target: Boost lifts every bin below it up (an "
        "exciter - quiet partials bloom), Attenuate caps every bin above it down (a per-bin "
        "spectral ceiling).";
