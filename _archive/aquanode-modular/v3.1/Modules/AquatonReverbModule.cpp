...
static ModuleDescriptor aquatonDescriptor()
{
    ...
    d.description =
        "A lush FDN reverb: eight modulated feedback-delay lines with input diffusion, per-line "
        "damping and a Householder matrix. Freeze holds the tank indefinitely - an instant "
        "infinite pad.";
