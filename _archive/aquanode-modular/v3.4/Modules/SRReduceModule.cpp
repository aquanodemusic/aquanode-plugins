...
static aquanode::ModuleDescriptor srReduceDescriptor()
{
    ...
    d.description =
        "Sample-rate reduction: holds each sample for several periods, aliasing the highs into "
        "inharmonic digital shimmer. Flexible: per-voice when patched per-voice.";
