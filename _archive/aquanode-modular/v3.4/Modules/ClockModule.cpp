...
static ModuleDescriptor clockDescriptor()
{
    ...
    d.displayName = "Clock";
    d.description =
        "A tempo-synced pulse generator with swing and tunable gate width, running "
        "continuously at the host tempo. Its Gate Out drives Step Seq and Euclid clock inputs, "
        "S&H, or any drum's Trig In. Reset In restarts the cycle on a rising edge and wants a "
        "Gate module (so playing a key restarts the pattern) or a slower Clock (to stay "
        "bar-locked). Any gate source will do for the Reset Socket.";
