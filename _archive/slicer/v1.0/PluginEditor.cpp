    ...
    : AudioProcessorEditor(&p), audioProcessor(p), waveformDisplay(p)
{
    ...
    auto setupSlider = [this](juce::Slider& slider, juce::Label& label,
        ...
        std::unique_ptr<juce::AudioProcessorValueTreeState::SliderAttachment>& attachment)
        {
            ...
            slider.setLookAndFeel(&customKnobLookAndFeel); // Apply custom look and feel
    ...
    setupSlider(fadeoutMsSlider, fadeoutMsLabel, "Fadeout (ms)", "fadeoutMs", fadeoutMsAttachment);
    
    // Slice End Mode combobox
    ...
    // Add onChange callback to re-analyze when mode changes
...
void SlicerAudioProcessorEditor::resized()
{
    ...
    exportButton.setBounds(exportSectionX, exportSectionY + smallKnobSize + 45, 160, 40);
}