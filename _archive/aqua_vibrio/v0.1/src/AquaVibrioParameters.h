...
inline const std::vector<ParamInfo>& allParameters()
{
    ...
    {
        // --- oscA ---
        { "Osc1HypersawDensity", "Osc1 HyperSaw/Density", "Oscillator 1 Density", "oscA", 112, 17, 0, 127, 0, ValueScale::Continuous, "" },
        ...
        { "Osc1Semitone", "Osc1 Semitone", "Oscillator 1 Detune In Semitones", "oscA", 112, 20, 16, 112, 64, ValueScale::Bipolar, "" },
        ...
        // --- oscB ---
        { "Osc2HypersawDensity", "Osc2 HyperSaw/Density", "Oscillator 2 Density", "oscB", 112, 22, 0, 127, 0, ValueScale::Continuous, "" },
        ...
        { "Osc2Semitone", "Osc2 Semitone", "Oscillator 2 Detune In Semitones", "oscB", 112, 25, 16, 112, 64, ValueScale::Bipolar, "" },
        { "Osc2Detune", "Osc2 Detune", "Oscillator 2 Fine Detune", "oscB", 112, 26, 0, 127, 32, ValueScale::Continuous, "" },
        { "Osc2HypersawCrossoscsyncfreq", "Osc2 HyperSaw/CrossOscSyncFreq", "X-Sync Frequency", "oscB", 112, 27, 0, 127, 0, ValueScale::Continuous, "" },
        ...
        { "Osc2Sync", "Osc2 Sync", "Oscillator 1 Sync", "oscB", 112, 28, 0, 1, 0, ValueScale::Continuous, "" },
        ...
        { "Osc2HsawFiltEnvSyncFreq", "Osc2 HyperSaw/FilterEnv > SyncFrequency", "Filter Envelope > X-Sync", "oscB", 112, 30, 0, 127, 64, ValueScale::BipolarPercent, "" },
        ...
        { "Osc3Semitone", "Osc3 Semitone", "Oscillator 3 Detune In Semitone", "oscC", 113, 43, 16, 112, 64, ValueScale::Bipolar, "" },
        ...
        // --- noise ---
        { "NoiseVolume", "Noise Volume", "Noise Oscillator Volume", "noise", 112, 37, 0, 127, 0, ValueScale::Continuous, "" },
        { "NoiseColor", "Noise Color", "Noise Color", "noise", 112, 39, 0, 127, 64, ValueScale::Bipolar, "" },
        // --- filterA ---
        ...
        { "Filter2Resonance", "Filter2 Resonance", "Filter 2 Resonance", "filterB", 112, 43, 0, 127, 64, ValueScale::Continuous, "" },
        ...
        { "Envelope3Sustain", "Envelope 3/Sustain", "Envelope 3/Sustain", "env3", 110, 82, 0, 127, 0, ValueScale::Percent, "" },
        { "Envelope3SustainTime", "Envelope 3/Sustain Time", "Envelope 3/Sustain Slope", "env3", 110, 83, 0, 127, 0, ValueScale::Bipolar, "" },
        ...
        { "Envelope4Sustain", "Envelope 4/Sustain", "Envelope 4/Sustain", "env4", 110, 87, 0, 127, 0, ValueScale::Percent, "" },
        { "Envelope4SustainTime", "Envelope 4/Sustain Time", "Envelope 4/Sustain Slope", "env4", 110, 88, 0, 127, 0, ValueScale::Bipolar, "" },
        ...
        // --- chorus ---
        { "ChorusType", "Chorus/Type", "Chorus/Type", "chorus", 112, 103, 0, 6, 0, ValueScale::Enum, "chorusType" },
        ...
        { "DelayType", "Delay Type", "Delay Type", "delay", 110, 10, 0, 3, 1, ValueScale::Enum, "delayType" },
        ...
        { "ReverbSend", "Reverb Send", "Reverb/Send", "reverb", 110, 2, 0, 127, 0, ValueScale::Enum, "send" },
        ...
        // --- punch ---
        { "PunchIntensity", "Punch Intensity", "Oscillator Punch Intensity", "punch", 113, 36, 0, 127, 64, ValueScale::Percent, "" },
        // --- input ---
        ...
        // --- bassBoost ---
        { "BassIntensity", "Bass Intensity", "Character Intensity", "bassBoost", 113, 97, 0, 127, 0, ValueScale::Percent, "" },
        { "BassTune", "Bass Tune", "Character Tune", "bassBoost", 113, 98, 0, 127, 32, ValueScale::Continuous, "" },
        // --- distortion ---
        ...
        // --- inputFollower ---
        { "InputFollowerAttack", "Input Follower/Attack", "Input Follower Envelope Attack", "inputFollower", 112, 54, 0, 127, 64, ValueScale::Continuous, "" },
        { "InputFollowerLevel", "Input Follower/Level", "Input Follower/Level", "inputFollower", 112, 56, 0, 127, 0, ValueScale::Continuous, "" },
        { "InputFollowerRelease", "Input Follower/Release", "Input Follower Envelope Release", "inputFollower", 112, 58, 0, 127, 64, ValueScale::Continuous, "" },
        { "InputFollowerMode", "Input Follower Mode", "Input Follower/Select", "inputFollower", 113, 38, 0, 3, 0, ValueScale::Enum, "inputFollowerMode" },
        // --- filterBank ---
        { "FilterBankType", "Filter Bank/Type", "Filter Bank Type", "filterBank", 110, 19, 0, 11, 1, ValueScale::Enum, "filterBankType" },
        ...
        { "CharacterType", "Character Type", "Character Type", "filterBank", 110, 26, 0, 8, 0, ValueScale::Enum, "characters" },
        // --- atomizer ---
        ...
        { "Atomizer", "Atomizer", "Atomizer", "atomizer", 111, 126, 0, 127, 0, ValueScale::Continuous, "" },
        // --- lfos ---
        ...
        // --- unplaced ---
        { "PortamentoTime", "Portamento Time", "Portamento Time", "", 112, 5, 0, 127, 0, ValueScale::Continuous, "" },
        ...
        { "Panorama", "Panorama", "Panorama", "", 112, 10, 0, 127, 64, ValueScale::Bipolar, "" },
        ...
        { "ClockTempo", "Clock Tempo", "Tempo (Disabled in Plug-In)", "", 113, 16, 0, 127, 57, ValueScale::Continuous, "" },
        ...
        else
        {
            layout.add (std::make_unique<juce::AudioParameterInt> (
                ...
                juce::AudioParameterIntAttributes().withStringFromValueFunction (
                    [scale = p.scale] (int v, int)
                    {
                        switch (scale)
                        {
                            case ValueScale::Bipolar:        return juce::String (v - 64);
