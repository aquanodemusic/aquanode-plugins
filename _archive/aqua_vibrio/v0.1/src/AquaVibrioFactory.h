...
inline const std::vector<FactoryPreset>& factoryPresets()
{
    static const std::vector<FactoryPreset> presets
    {
        ...
        { "Psytrance", "Psy Rolling Bass", {
            ...
            {"Cutoff",34},{"Filter1Resonance",20},{"Filter1EnvAmt",28},
            {"FilterEnvAttack",0},{"FilterEnvDecay",50},{"FilterEnvSustain",0},
            {"AmpEnvAttack",0},{"AmpEnvDecay",56},{"AmpEnvSustain",0},{"AmpEnvRelease",30},
            {"KeyMode",1},{"PortamentoTime",0},{"PatchVolume",115} } },
        ...
        { "Flutes", "Pan Whistle", {
            ...
            {"Cutoff",90},{"Filter1Resonance",55},{"Filter1Mode",2},
        ...
        { "Noise FX", "White Noise Sweep", {
            {"NoiseVolume",120},{"NoiseColor",127},{"OscMainvolume",0},
            {"Cutoff",30},{"Filter1Resonance",70},{"Filter1EnvAmt",90},
            {"FilterEnvAttack",78},{"FilterEnvDecay",95},{"FilterEnvSustain",0},
            {"AmpEnvAttack",60},{"AmpEnvSustain",110},{"AmpEnvRelease",80},
            {"ReverbSend",80} } },

        { "Noise FX", "Wind", {
            {"NoiseVolume",110},{"NoiseColor",60},{"OscMainvolume",0},
            {"Cutoff",52},{"Filter1Resonance",60},{"Filter1Mode",2},
