...
//==============================================================================
float TranswaveAudioProcessor::sampleFrameRaw(const WavetableSlot& s, float fi, double ph, bool interp, float smoothAmt) const {
    ...
    TranswaveVoice::Env& nextStage, float& nextReleaseStart)
{
    ...
    case TranswaveVoice::Env::Release:
        ...
        break;
    case TranswaveVoice::Env::Idle: level = 0.f; break;
    }
    ...
    const BlockEnvCoeffs& bc)
{
    ...
    float smoothA = pWtSmooth  ? pWtSmooth->load()  : 0.f;
    float smoothB = pWtSmoothB ? pWtSmoothB->load() : 0.f;
