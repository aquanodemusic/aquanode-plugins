...
static aquanode::ModuleDescriptor envFollowDescriptor()
{
    ...
    d.description =
        "Turns any audio into a modulation signal by rectifying and smoothing it with separate "
        "attack and release. Sidechain-style patching: a Kick into Env Follow, inverted through "
        "Align, into a Volume's Mod In.";
