...
private:
    ...
    // GUI scaling
    static constexpr int kBaseWidth = 1279;
    static constexpr int kBaseHeight = 719;
    ...
    bool  drawingMain = true;   // true = edit main curve, false = sidechain
    ...
    juce::Label      gateThreshLabel, gateLowHzLabel, gateHighHzLabel;
    ...
    juce::Slider     enhanceLevelSlider;
    juce::Label      enhLevelLabel, enhLowHzLabel, enhHighHzLabel;
    ...
    juce::TextButton morphSmoothToggle;   // smoothMorphAudio — audible temporal hold
    juce::TextButton drawTargetButton;    // "Draw Main" / "Draw Side" toggle
    juce::TextButton resetDrawsButton;    // "Reset Draws"
    ...
    std::unique_ptr<SliderAttachment>   enhanceLevelAttachment;
