...
// ==============================================================
//  Colour palette  (shared visual identity with AlphaBeta)
// ==============================================================
namespace FXPal {
...
// ==============================================================
//  Custom LookAndFeel  (mirrors AlphaLAF)
// ==============================================================
...
private:
    ...
    // ---- Chorus ----
    FXLKnob hWet { "Chorus Wet" };
    FXLKnob hTime{ "Chorus Time" };
    FXLKnob hRate{ "Chorus Rate" };

    // ---- Attachments ----
    using SA = juce::AudioProcessorValueTreeState::SliderAttachment;
    using CA = juce::AudioProcessorValueTreeState::ComboBoxAttachment;

    std::unique_ptr<SA> att_drv, att_fcut, att_fres, att_hwet, att_htim, att_hrat;
    std::unique_ptr<CA> att_ftyp, att_rtyp;

    // ---- Layout ----
    // Cols: Drive(95) | Sep(22) | Cutoff(95) | Res(95) | Sep(22) | Wet(95) | Time(95) | Rate(95)
    static constexpr int TITLE_H = 34;
    static constexpr int NCOLS   = 8;
    static constexpr int CW[NCOLS] = { 95, 22, 95, 95, 22, 95, 95, 95 };
