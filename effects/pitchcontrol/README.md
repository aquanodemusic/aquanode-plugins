...
![PitchControl banner](assets/Banner.webp)
...
- **1.1** — Adds a Boost Unfiltered Frequency and Q Knob Combination.
- **2.0** — Adds a spectrogram and filter curve viewer and an FFT mode that shifts FFT bins to the next active note.
- **2.1** — Adds a ring mod to the FFT mode and a global gain to the regular mode.
