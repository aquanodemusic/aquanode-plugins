...
public:
    ...
    static constexpr const char* PARAM_HUM_DRIFT_RATE = "humDriftRate";
    static constexpr const char* PARAM_HUM_DRIFT_DEPTH = "humDriftDepth";
    ...
    static constexpr const char* PARAM_INPUT_DRIFT_RATE = "inputDriftRate";
    static constexpr const char* PARAM_INPUT_DRIFT_DEPTH = "inputDriftDepth";
    static constexpr const char* PARAM_INPUT_WOBBLE = "inputWobble";
    static constexpr const char* PARAM_INPUT_WOBBLE_RATE = "inputWobbleRate";
    static constexpr const char* PARAM_INPUT_WOBBLE_DEPTH = "inputWobbleDepth";
    static constexpr const char* PARAM_INPUT_DELAY_BASE = "inputDelayBase";
    static constexpr const char* PARAM_INPUT_DELAY_MOD = "inputDelayMod";
    ...
    static constexpr const char* PARAM_SATURATION = "saturation";
...
private:
    ...
    std::atomic<float>* humDriftRateParam = nullptr;
    std::atomic<float>* humDriftDepthParam = nullptr;
    ...
    std::atomic<float>* inputDriftRateParam = nullptr;
    std::atomic<float>* inputDriftDepthParam = nullptr;
    std::atomic<float>* inputWobbleParam = nullptr;
    std::atomic<float>* inputWobbleRateParam = nullptr;
    std::atomic<float>* inputWobbleDepthParam = nullptr;
    std::atomic<float>* inputDelayBaseParam = nullptr;
    std::atomic<float>* inputDelayModParam = nullptr;
