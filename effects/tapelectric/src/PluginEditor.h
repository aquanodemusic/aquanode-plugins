...
private:
    ...
    juce::Slider humDriftRateSlider, humDriftDepthSlider;
    ...
    juce::Slider inputDriftRateSlider, inputDriftDepthSlider;
    juce::Slider inputWobbleRateSlider, inputWobbleDepthSlider;
    juce::Slider inputDelayBaseSlider, inputDelayModSlider;
    ...
    juce::Label humDriftRateLabel, humDriftDepthLabel;
    ...
    juce::Label inputDriftRateLabel, inputDriftDepthLabel;
    juce::Label inputWobbleRateLabel, inputWobbleDepthLabel;
    juce::Label inputDelayBaseLabel, inputDelayModLabel;
    ...
    std::unique_ptr<SliderAttachment> humDriftRateAtt, humDriftDepthAtt;
    ...
    std::unique_ptr<SliderAttachment> inputDriftRateAtt, inputDriftDepthAtt;
    std::unique_ptr<SliderAttachment> inputWobbleRateAtt, inputWobbleDepthAtt;
    std::unique_ptr<SliderAttachment> inputDelayBaseAtt, inputDelayModAtt;
    std::unique_ptr<SliderAttachment> saturationAtt;
