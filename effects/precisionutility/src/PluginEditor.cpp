    ...
    : AudioProcessorEditor(&p), audioProcessor(p)
{
    ...
    delaySlider.setSkewFactorFromMidPoint(100.0f); // Logarithmic: midpoint at 100ms
    ...
    // === Volume Left Section ===
    volLeftLabel.setText("Vol Left", juce::dontSendNotification);
    volLeftLabel.setJustificationType(juce::Justification::centred);
    volLeftLabel.setColour(juce::Label::textColourId, juce::Colours::white);
    addAndMakeVisible(volLeftLabel);

    volLeftSlider.setSliderStyle(juce::Slider::LinearVertical);
    volLeftSlider.setTextBoxStyle(juce::Slider::TextBoxBelow, false, 80, 20);
    volLeftSlider.setColour(juce::Slider::thumbColourId, juce::Colours::white);
    volLeftSlider.setColour(juce::Slider::trackColourId, juce::Colour(0xff00ffff));
    volLeftSlider.setColour(juce::Slider::backgroundColourId, juce::Colour(0xff004444));
    volLeftSlider.setColour(juce::Slider::textBoxTextColourId, juce::Colours::white);
    volLeftSlider.setColour(juce::Slider::textBoxBackgroundColourId, juce::Colour(0xff003333));
    volLeftSlider.setColour(juce::Slider::textBoxOutlineColourId, juce::Colour(0xff00ffff));
    addAndMakeVisible(volLeftSlider);
    volLeftAttachment = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(
        audioProcessor.apvts, "volLeft", volLeftSlider);

    // === Volume Right Section ===
    volRightLabel.setText("Vol Right", juce::dontSendNotification);
    volRightLabel.setJustificationType(juce::Justification::centred);
    volRightLabel.setColour(juce::Label::textColourId, juce::Colours::white);
    addAndMakeVisible(volRightLabel);

    volRightSlider.setSliderStyle(juce::Slider::LinearVertical);
    volRightSlider.setTextBoxStyle(juce::Slider::TextBoxBelow, false, 80, 20);
    volRightSlider.setColour(juce::Slider::thumbColourId, juce::Colours::white);
    volRightSlider.setColour(juce::Slider::trackColourId, juce::Colour(0xff00ffff));
    volRightSlider.setColour(juce::Slider::backgroundColourId, juce::Colour(0xff004444));
    volRightSlider.setColour(juce::Slider::textBoxTextColourId, juce::Colours::white);
    volRightSlider.setColour(juce::Slider::textBoxBackgroundColourId, juce::Colour(0xff003333));
    volRightSlider.setColour(juce::Slider::textBoxOutlineColourId, juce::Colour(0xff00ffff));
    addAndMakeVisible(volRightSlider);
    volRightAttachment = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(
        audioProcessor.apvts, "volRight", volRightSlider);
...
void PrecisionUtilityAudioProcessorEditor::resized()
{
    ...
    // Vol Left section
    auto volLeftBounds = bounds.removeFromLeft(sliderWidth);
    volLeftLabel.setBounds(volLeftBounds.removeFromTop(25));
    volLeftBounds.removeFromTop(5);
    volLeftSlider.setBounds(volLeftBounds.removeFromTop(330));

    bounds.removeFromLeft(spacing);

    // Vol Right section
    auto volRightBounds = bounds.removeFromLeft(sliderWidth);
    volRightLabel.setBounds(volRightBounds.removeFromTop(25));
    volRightBounds.removeFromTop(5);
    volRightSlider.setBounds(volRightBounds.removeFromTop(330));
